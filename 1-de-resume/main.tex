...
\item \textbf{Technologies:} Google Cloud Platform (GCP), BigQuery, Cloud Composer/Airflow, Google Cloud Functions, Google Cloud Scheduler
\item \textbf{Frameworks/Libraries:} Django, Flask, FastAPI
\item \textbf{Tools:} Git, VS Code, Docker, CI/CD Azure Pipelines, Azure DevOps
\item \textbf{Databases:} RDBMS MySQL

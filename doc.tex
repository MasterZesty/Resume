...
%----------- SLB EXPERIENCE -----------
	...
	\resumeSubheading
  	{Schlumberger}{Aug 2021 - Present}
  	{Associate Software Engineer}{Pune, India}
  	\resumeItemListStart
    	\resumeItem{Working on google cloud platform, data engineering.}
    	%-\resumeItem{}
    	%-\resumeItem{}
    \resumeItemListEnd
...
\section{Projects}
	...
	\resumeProjectHeading
      	{\textbf{Data Monitoring and Acquisition System For All Terrain Vehicle} $|$ \emph{Python, MySQL, Google Sheets API} $|$ {{\href{https://github.com/MasterZesty/}{\underline{Github}}}}}{June 2021}
      	\resumeItemListStart
